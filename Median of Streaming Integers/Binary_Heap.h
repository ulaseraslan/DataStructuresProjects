...
// Comparable findTop( )  --> Return smallest item
...
// max_heap class inherited from Binary Heap Class
//
//
// ******************PUBLIC OPERATIONS*********************
// void insert( x )       --> Insert x
// deleteMax()            --> Remove (and optionally return) greatest item
// percolateUp(int hole)
template <typename Comparable>

class max_heap: public BinaryHeap<Comparable> {
